...
#if defined(_WIN32) and SF_RUNTIME_EXCEPTIONS
...
#    include <typeinfo>
    ...
    static bool sf_class_is_kind_of(const SFObjCClass_t *actual, const SFObjCClass_t *wanted)
    {
    ...
    struct __objc_class_type_info : public __objc_type_info {
        ...
        bool __do_catch(const std::type_info *thrown_type, void **thrown_object, unsigned outer) const override
        {
            ...
            if (wanted == nullptr or actual == nullptr or not sf_class_is_kind_of(actual, wanted)) {
                return false;
            }
