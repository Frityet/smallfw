...
int sf_selector_equal(SEL nillable a, SEL nillable b);
...
int sf_class_has_trivial_release(Class nillable cls);
...
int sf_class_is_constant_string(Class nillable cls);
...
#endif
int sf_is_tagged_pointer(id nillable obj);
...
int sf_header_set_allocator(SFObjHeader_t *nillable hdr, SFAllocator_t *nillable allocator);
#if SF_RUNTIME_GENERIC_METADATA
Class nillable sf_header_generic_type_class(SFObjHeader_t *nillable hdr);
int sf_header_set_generic_type_class(SFObjHeader_t *nillable hdr, Class nillable cls);
...
int sf_header_is_inline_value_prefix(SFObjHeader_t *nillable hdr);
...
int sf_header_set_parent(SFObjHeader_t *nillable hdr, id nillable parent);
SFObjHeader_t *nillable sf_header_group_root(SFObjHeader_t *nillable hdr);
int sf_header_set_group_root(SFObjHeader_t *nillable hdr, SFObjHeader_t *nillable group_root);
SFObjHeader_t *nillable sf_header_group_next(SFObjHeader_t *nillable hdr);
int sf_header_set_group_next(SFObjHeader_t *nillable hdr, SFObjHeader_t *nillable group_next);
SFObjHeader_t *nillable sf_header_group_head(SFObjHeader_t *nillable hdr);
int sf_header_set_group_head(SFObjHeader_t *nillable hdr, SFObjHeader_t *nillable group_head);
size_t sf_header_group_live_count(SFObjHeader_t *nillable hdr);
int sf_header_set_group_live_count(SFObjHeader_t *nillable hdr, size_t count);
int sf_header_group_dead(SFObjHeader_t *nillable hdr);
int sf_header_grouped(SFObjHeader_t *nillable hdr);
int sf_header_init_group_root(SFObjHeader_t *nillable hdr);
...
static inline int sf_runtime_test_consume_allocation(void)
{
    return 1;
}
...
size_t sf_runtime_test_dispatch_collect_explicit_arg_codes(SEL nillable op, char *nonnil out_codes, int *nillable unsupported_sig);
size_t sf_runtime_test_dispatch_collect_explicit_arg_codes_cached(SEL nillable op, char *nonnil out_codes, int *nillable unsupported_sig);
...
int sf_runtime_test_exception_matches_type(struct _Unwind_Exception *nillable exception_object,
...
int sf_runtime_test_exception_parse_lsda(const uint8_t *nillable lsda, uintptr_t func_start, uintptr_t ip,
