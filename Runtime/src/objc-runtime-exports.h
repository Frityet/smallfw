...
SF_RUNTIME_EXPORT void objc_msgSend_stret(void *nonnil outst, id nillable receiver, SEL nillable op, ...);
...
SF_RUNTIME_EXPORT struct sf_objc_slot *nonnil objc_msg_lookup_sender(id nillable *nonnil receiver, SEL nillable op, void *nillable sender);
...
SF_RUNTIME_EXPORT IMP nillable method_getImplementation(Method nillable method);
...
SF_RUNTIME_EXPORT bool sel_isEqual(SEL nillable lhs, SEL nillable rhs);
