...
#include "runtime-test-support.h"
    ...
    static bool case_tagged_arc_noop_semantics(void)
    {
    ...
    static bool case_tagged_object_decode_paths(void)
    {
        __unsafe_unretained TaggedNumberProbe *num = [TaggedNumberProbe numberWithValue:99U];
        const char *name = nullptr;
        auto cls = (Class)objc_getClass("TaggedNumberProbe");
    ...
    static bool case_tagged_dispatch_methods(void)
    {
        __unsafe_unretained TaggedNumberProbe *num = [TaggedNumberProbe numberWithValue:41U];
    ...
    static bool case_tagged_slot_registration_rules(void)
    {
        auto conflicted = sf_test_make_raw_tagged(3U, 7U);
        auto unknown = sf_test_make_raw_tagged(7U, 11U);
