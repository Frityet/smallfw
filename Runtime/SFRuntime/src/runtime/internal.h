...
static inline void *_Nullable sf_runtime_test_malloc(size_t size)
{
    return malloc(size);
}

static inline void *_Nullable sf_runtime_test_calloc(size_t count, size_t size)
{
    return calloc(count, size);
}

static inline void *_Nullable sf_runtime_test_realloc(void *_Nullable ptr, size_t size)
{
