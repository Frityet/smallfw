...
#include "blocksruntime/Block-private.h"
...
static inline int object_is_block(id obj)
{
    ...
    void *isa = block->isa;
    return isa == (void *)_NSConcreteStackBlock or isa == (void *)_NSConcreteMallocBlock or isa == (void *)_NSConcreteAutoBlock or isa == (void *)_NSConcreteFinalizingBlock or isa == (void *)_NSConcreteGlobalBlock;
}
...
{
    if (hdr == nullptr or(hdr->flags & SF_OBJ_FLAG_IMMORTAL) != 0U or hdr->state != SF_OBJ_STATE_LIVE or embedded_owner_slot_contains_object(hdr, obj)) {
        return obj;
    }
