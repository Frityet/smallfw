...
static size_t sf_string_utf8_unit_length(const char *bytes, size_t length)
{
    size_t offset = 0U;
    size_t units = 0U;
    if (bytes == nullptr) {
...
static unsigned short sf_string_utf8_character_at(const char *bytes, size_t length, size_t idx)
{
    size_t offset = 0U;
    size_t units = 0U;
