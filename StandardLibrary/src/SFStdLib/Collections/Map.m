                          ...
                          count:(size_t)count
{
    ...
    auto tmp_keys = (id *)[self allocateMemoryWithSize:sizeof(id) * count alignment:alignof(id)];
    auto tmp_values = (id *)[self allocateMemoryWithSize:sizeof(id) * count alignment:alignof(id)];
    size_t used = 0U;
...
- (bool)isEqual:(Object *)other
{
    ...
    for (size_t i = 0U; i < _count; ++i) {
        auto lhs_value = _values[i];
        auto rhs_value = [rhs objectForKey:_keys[i]];
