local runtime_test_suite_specs = {
    ...
    },
    {
        ...
        cases = {
            ...
            "parent_fast_object_rejected",
            "parent_inline_value_options_are_class_local",
            "parent_fast_object_options_are_class_local",
            "parent_invalid_trivial_release_rejected",
    ...
    },
    {
        ...
        cases = function ()
            local cases = {
                ...
                "loader_trivial_release_options",
