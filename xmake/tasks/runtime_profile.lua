task("run-runtime-profile")
    ...
    set_menu {
        ...
        description = "Build an instrumented runtime-bench, capture profile artifacts, and record metadata. Recommended fastest combo: --runtime-native-tuning=y --runtime-thinlto=y --dispatch-l0-dual=y --dispatch-cache-2way=y --dispatch-cache-negative=y --runtime-compact-headers=y --runtime-fast-objects=y --runtime-inline-value-storage=y --runtime-inline-group-state=y --pgo=use --bolt=on --profiler=perf.",
