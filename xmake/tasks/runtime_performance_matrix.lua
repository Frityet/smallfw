local function define_runtime_performance_matrix_task(name)
    task(name)
        ...
        set_menu {
            ...
            description = "Run the runtime benchmark matrix for the GNUstep ABI and generate measured markdown docs. The default matrix is the full Linux x86_64 coverage set.",
            options = {
