...
function smallfw.runtime_config_menu_options(extra_options, defaults)
    ...
    local options = {
        ...
        {nil, "dispatch-l0-dual", "kv", nil, "Override dispatch-l0-dual.", " - y", " - n"},
        {nil, "dispatch-cache-2way", "kv", nil, "Override dispatch-cache-2way.", " - y", " - n"},
        {nil, "dispatch-cache-negative", "kv", nil, "Override dispatch-cache-negative.", " - y", " - n"},
