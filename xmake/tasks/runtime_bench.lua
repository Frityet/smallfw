task("run-runtime-bench")
    ...
    set_menu {
        ...
        description = "Build runtime-bench, run repeated benchmark samples, and record structured results. Recommended fastest combo: --runtime-native-tuning=y --runtime-thinlto=y --dispatch-l0-dual=y --dispatch-cache-2way=y --dispatch-cache-negative=y --runtime-compact-headers=y --runtime-fast-objects=y --runtime-inline-value-storage=y --runtime-inline-group-state=y --pgo=use --bolt=on.",
